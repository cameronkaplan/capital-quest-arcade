...
const BONUS_GAMES = [
  ...
  },
  {
    ...
    calls: [
      ...
      { targetAbbr: "MD", answerKind: "capital", contextAbbrs: ["MD", "DE", "VA"], caller: "Nursery Rhyme Trouble", line: "Mary had a little land. Then a police officer came and shut the whole thing down.", prompt: "Which capital belongs to Maryland?", choices: ["MD", "DE", "VA", "PA"] },

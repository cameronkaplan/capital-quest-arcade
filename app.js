...
const BONUS_GAMES = [
  ...
  },
  {
    ...
    calls: [
      ...
      { targetAbbr: "PA", answerKind: "capital", contextAbbrs: ["PA", "NY", "MD"], caller: "Hairy burger line", line: "Pennsylvania says the capital is not Philly or Pittsburgh. Think hairy burger.", prompt: "Which capital belongs to Pennsylvania?", choices: ["PA", "NY", "MD", "DE"], audio: "assets/audio/capital-harrisburg-pennsylvania.mp3" },

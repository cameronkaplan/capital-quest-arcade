...
const BONUS_GAMES = [
  ...
  },
  {
    ...
    calls: [
      ...
      { targetAbbr: "WV", answerKind: "capital", contextAbbrs: ["WV", "VA", "KY"], caller: "Mountain dance line", line: "West Virginia is having a mountain dance party with fancy footwork through the hills.", prompt: "Which capital belongs to West Virginia?", choices: ["WV", "VA", "KY", "TN"], audio: "assets/audio/capital-charleston-west-virginia.mp3" }
    ]
  }
];

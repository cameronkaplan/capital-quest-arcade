...
const BONUS_GAMES = [
  ...
  },
  {
    ...
    calls: [
      ...
      { targetAbbr: "TN", answerKind: "capital", contextAbbrs: ["TN", "KY", "MS"], caller: "Music City line", line: "Well hey, darlin', Tennessee here and I brought my guitar! But, I got a tendency to gnash my teeth before I go on stage.", prompt: "Which capital belongs to Tennessee?", choices: ["TN", "KY", "MS", "AL"], audio: "assets/audio/capital-nashville-tennessee.mp3" },
      ...
      { targetAbbr: "MA", contextAbbrs: ["MA", "RI", "CT"], caller: "Boston on line six", line: "Listen, kid, I went to Harvard, so I know mass. And the boss says this thing weighs a ton. A whole boss-ton of mass. Wicked heavy.", prompt: "Boston is calling from which state?", choices: ["MA", "RI", "CT", "NH"], audio: "assets/audio/capital-boston-massachusetts.mp3" },
      ...
      { targetAbbr: "AL", answerKind: "capital", contextAbbrs: ["AL", "MS", "GA"], caller: "Mountain-gum dispatch", line: "Al-Bam from the mountain gumery. I'm sittin' here on a mountain of gum and business is stickier than ever.", prompt: "Which capital belongs to Alabama?", choices: ["AL", "MS", "GA", "TN"], audio: "assets/audio/capital-montgomery-alabama.mp3" },
      ...
      { targetAbbr: "AR", contextAbbrs: ["AR", "LA", "MS"], caller: "Noah from the Ark", line: "Noah's journal, day three-twenty. From the ark, we saw a little rock. Still no land. The animals are getting restless!", prompt: "Little Rock is the capital of which state?", choices: ["AR", "LA", "MS", "OK"], audio: "assets/audio/capital-little-rock-arkansas.mp3" },
      { targetAbbr: "CT", answerKind: "capital", contextAbbrs: ["CT", "RI", "MA"], caller: "New England teacher", line: "Okay, class, time to connect and cut. First, connect the dots. Then cut out heart four. Heart four, please. Not heart three. We are not doing that again.", prompt: "Which capital belongs to Connecticut?", choices: ["CT", "RI", "MA", "NJ"], audio: "assets/audio/capital-hartford-connecticut.mp3" },
      { targetAbbr: "DE", answerKind: "capital", contextAbbrs: ["DE", "MD", "NJ"], caller: "Driving-over desk", line: "Della! Where is my Nintendo controller? Della, where? Hand it over.", prompt: "Which capital belongs to Delaware?", choices: ["DE", "MD", "NJ", "PA"], audio: "assets/audio/capital-dover-delaware.mp3" },
      ...
      { targetAbbr: "GA", answerKind: "capital", contextAbbrs: ["GA", "AL", "SC"], caller: "Sailing the Atlantic", line: "Ayy, it's Georgia. I'm sailin' the Atlantic, lookin' real fancy.", prompt: "Which capital belongs to Georgia?", choices: ["GA", "AL", "SC", "NC"], audio: "assets/audio/capital-atlanta-georgia.mp3" },
      ...
      { targetAbbr: "LA", answerKind: "capital", contextAbbrs: ["LA", "MS", "AR"], caller: "Red baton relay", line: "Louise and Anna here. Today we're putting rouge on a bat. Low-key, this bat is serving night creature glam!", prompt: "Which capital belongs to Louisiana?", choices: ["LA", "MS", "AR", "TX"], audio: "assets/audio/capital-baton-rouge-louisiana-2.mp3" },
      { targetAbbr: "ME", answerKind: "capital", contextAbbrs: ["ME", "NH", "VT"], caller: "Lion with a mane problem", line: "Roar! A gust-uh wind hit my mane. This is unacceptable! I had volume. I had dignity!", prompt: "Which capital belongs to Maine?", choices: ["ME", "NH", "VT", "MA"], audio: "assets/audio/capital-augusta-maine.mp3" },
      { targetAbbr: "MD", answerKind: "capital", contextAbbrs: ["MD", "DE", "VA"], caller: "Nursery Rhyme Trouble", line: "Mary had a little land. Then a police officer came and shut the whole thing down.", prompt: "Which capital belongs to Maryland?", choices: ["MD", "DE", "VA", "PA"], audio: "assets/audio/capital-annapolis-maryland.mp3" },
      { targetAbbr: "MS", answerKind: "capital", contextAbbrs: ["MS", "AL", "LA"], caller: "Ole' Mississippi Jack", line: "Jack's on a raft, floatin' down the Mississippi. Jack's on a river, hummin' the blues.", prompt: "Which capital belongs to Mississippi?", choices: ["MS", "AL", "LA", "TN"], audio: "assets/audio/capital-jackson-mississippi.m4a" },
      ...
      { targetAbbr: "NJ", answerKind: "capital", contextAbbrs: ["NJ", "NY", "DE"], caller: "Jersey train line", line: "Yo, what's up? It's Trent. I just put my new jersey on and honestly? The fit is loud and Trent is fully on.", prompt: "Which capital belongs to New Jersey?", choices: ["NJ", "NY", "DE", "PA"], audio: "assets/audio/capital-trenton-new-jersey.mp3" },
      ...
      { targetAbbr: "NY", answerKind: "capital", contextAbbrs: ["NY", "NJ", "PA"], caller: "Organized family bunny business", line: "Listen here, in New York, all bunnies enjoy springtime. Every bunny. Real nice season. Capisce?", prompt: "Which capital belongs to New York?", choices: ["NY", "NJ", "PA", "CT"], audio: "assets/audio/capital-albany-new-york.mp3" },
      ...
      { targetAbbr: "OK", answerKind: "capital", contextAbbrs: ["OK", "AR", "TX"], caller: "Too easy", line: "Oklahoma calling. Our capital has a big cowboy museum, lots of oil history, and more Native American communities than any other place. The name is also extremely easy to remember. Like... embarrassingly easy.", prompt: "Which capital belongs to Oklahoma?", choices: ["OK", "AR", "TX", "KS"], audio: "assets/audio/capital-oklahoma-city-oklahoma.mp3" },
      ...
      { targetAbbr: "PA", answerKind: "capital", contextAbbrs: ["PA", "NY", "MD"], caller: "Hairy burger line", line: "Ahright, yinz, grab yer pencil and draw me a hairy burger. Yeah, you heard me, a burger with hair on it n'at.", prompt: "Which capital belongs to Pennsylvania?", choices: ["PA", "NY", "MD", "DE"], audio: "assets/audio/capital-harrisburg-pennsylvania.mp3" },
      { targetAbbr: "RI", answerKind: "capital", contextAbbrs: ["RI", "CT", "MA"], caller: "Bike alibi", line: "Listen, I rode the island on my bike. But you can't prove I dented it. That's my story.", prompt: "Which capital belongs to Rhode Island?", choices: ["RI", "CT", "MA", "VT"], audio: "assets/audio/capital-providence-rhode-island.mp3" },
      { targetAbbr: "SC", answerKind: "capital", contextAbbrs: ["SC", "NC", "GA"], caller: "Column of bees", line: "Caroline! Run south, girl! There's a column-uh bees comin' right atcha! South, Caroline! Move those feet!", prompt: "Which capital belongs to South Carolina?", choices: ["SC", "NC", "GA", "VA"], audio: "assets/audio/capital-columbia-south-carolina.mp3" },
      ...
      { targetAbbr: "VT", answerKind: "capital", contextAbbrs: ["VT", "NH", "NY"], caller: "It's not a potato!", line: "Calling in from a very mountainy region. Very, very mountain, and we got a fella up here tryin' to peel a mountain. Says his name is Monty Peeler. I told him mountains don't work like potatoes.", prompt: "Which capital belongs to Vermont?", choices: ["VT", "NH", "NY", "ME"], audio: "assets/audio/capital-montpelier-vermont.mp3" },
      { targetAbbr: "VA", answerKind: "capital", contextAbbrs: ["VA", "NC", "WV"], caller: "History money line", line: "Hi y'all, it's Virginia. My daddy's a rich man, and he wants everybody to know it.", prompt: "Which capital belongs to Virginia?", choices: ["VA", "NC", "WV", "MD"], audio: "assets/audio/capital-richmond-virginia.mp3" },
      ...
      { targetAbbr: "WV", answerKind: "capital", contextAbbrs: ["WV", "VA", "KY"], caller: "Charles Stone", line: "Reporting live from west of Virginia's place. Charles is guarding a stone he claims is his. Charles' stone.", prompt: "Which capital belongs to West Virginia?", choices: ["WV", "VA", "KY", "TN"], audio: "assets/audio/capital-charleston-west-virginia.mp3" }
    ]
  }
];
